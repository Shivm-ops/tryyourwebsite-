...
import { Clock, Leaf, Cake, Truck, ArrowRight, Camera } from "lucide-react";
...
const products = [
  { name: "Sourdough Loaf",      price: "₹120",     fallback: "https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=500&q=75",   key: "bakery_p1" },
  { name: "Butter Croissant",    price: "₹65",      fallback: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500&q=75",   key: "bakery_p2" },
  { name: "Multigrain Bread",    price: "₹140",     fallback: "https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=500&q=75", key: "bakery_p3" },
  { name: "Pavs (1 doz)",        price: "₹40",      fallback: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=500&q=75", key: "bakery_p4" },
  { name: "Choc Truffle Cake",   price: "₹450/kg",  fallback: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=500&q=75", key: "bakery_p5" },
  { name: "Black Forest Cake",   price: "₹380/kg",  fallback: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=500&q=75", key: "bakery_p6" },
  { name: "Plum Cake",           price: "₹350/kg",  fallback: "https://images.unsplash.com/photo-1511018556340-d16986a1c194?w=500&q=75", key: "bakery_p7" },
  { name: "Almond Cookies (doz)","price": "₹180",   fallback: "https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=500&q=75", key: "bakery_p8" },
];

const gallerySlots = [
  { fallback: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80", key: "bakery_g1" },
  { fallback: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&q=80",    key: "bakery_g2" },
  { fallback: "https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=600&q=80", key: "bakery_g3" },
  { fallback: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=600&q=80", key: "bakery_g4" },
  { fallback: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=600&q=80", key: "bakery_g5" },
  { fallback: "https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=600&q=80", key: "bakery_g6" },
];
...
export default function BakeryPage() {
  return (
    <div className={`${cormorant.variable} ${dmSans.variable} font-[family-name:var(--font-dm-sans)]`} style={{ backgroundColor: BG, color: TEXT }}>
      ...
      {/* ── Hero (existing hero photo, clickable via DemoPhotoHero) ── */}
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 py-24 text-center overflow-hidden">
        <DemoPhotoHero
          fallbackUrl="https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1200&q=80"
          overlayOpacity={0.45}
        />
        <DemoStamp />
        <div className="relative z-20 max-w-3xl mx-auto backdrop-blur-[2px] bg-white/40 p-8 md:p-12 rounded-3xl border border-white/20 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#products" className="px-8 py-3.5 rounded-full font-semibold text-sm transition-all hover:scale-105 shadow-md hover:shadow-lg" style={{ backgroundColor: ACCENT, color: "#fff" }}>
              Explore our breads &amp; cakes
            </a>
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="px-8 py-3.5 rounded-full font-semibold text-sm border-2 transition-all hover:bg-white/50" style={{ borderColor: ACCENT, color: ACCENT }}>
              Order on WhatsApp
            </a>
          </div>
        </div>
      ...
      <section id="story" className="py-24 px-4" style={{ backgroundColor: BG_ALT }}>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 items-center">
          <div className="flex-1">
            ...
            <h2 className="font-[family-name:var(--font-cormorant)] text-4xl md:text-5xl font-bold mb-6 leading-tight" style={{ color: TEXT }}>
          ...
          {/* ✅ About photo — click to change */}
          <div className="flex-1 w-full relative">
            <div className="relative w-full h-[380px] rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
              <DemoImage
                storageKey="bakery_about"
                fallbackSrc="https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=800&q=80"
                alt="Baker working"
                fill
              />
            </div>
      ...
      <section id="products" className="py-24 px-4" style={{ backgroundColor: BG }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="font-[family-name:var(--font-cormorant)] text-4xl md:text-5xl font-bold" style={{ color: TEXT }}>
              Our Oven Specialties
            </h2>
            <p className="text-base mt-3 max-w-md mx-auto" style={{ color: MUTED }}>
              Hand-shaped, slow-fermented, and baked with premium ingredients.
            </p>
            {/* Hint label */}
            <p className="mt-4 inline-flex items-center gap-1.5 text-[11px] font-bold text-amber-700 bg-amber-50 border border-amber-100 px-3 py-1.5 rounded-full">
              <Camera className="w-3.5 h-3.5" />
              Hover any photo below to replace it with your own product image
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {products.map((product) => (
              <div
                key={product.key}
                className="rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border bg-white"
                style={{ borderColor: BORDER }}
              >
                {/* ✅ Each product photo — individually clickable */}
                ...
                <div className="p-6">
                  <p className="text-lg font-bold mb-1 font-[family-name:var(--font-cormorant)]" style={{ color: TEXT }}>
                    {product.name}
                  </p>
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <a
                      ...
                      className="text-xs font-semibold px-4 py-2 rounded-full border transition-colors hover:bg-[#8C4A32] hover:text-white"
      ...
      <section id="why-us" className="py-24 px-4" style={{ backgroundColor: BG_ALT }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feat) => (
              <div key={feat.label} className="flex flex-col items-center text-center p-8 rounded-3xl border bg-white shadow-sm hover:shadow-md transition-shadow" style={{ borderColor: BORDER }}>
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6" style={{ backgroundColor: `${ACCENT}15` }}>
      ...
      <section className="py-24 px-4" style={{ backgroundColor: BG }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-[family-name:var(--font-cormorant)] text-4xl font-bold" style={{ color: TEXT }}>
              From Our Kitchen to Your Table
            </h2>
            <p className="text-base mt-2" style={{ color: MUTED }}>A glimpse behind the scenes at our Rajarampuri bakeshop.</p>
            <p className="mt-4 inline-flex items-center gap-1.5 text-[11px] font-bold text-amber-700 bg-amber-50 border border-amber-100 px-3 py-1.5 rounded-full">
              <Camera className="w-3.5 h-3.5" />
              Click any gallery photo to upload your own
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {gallerySlots.map((slot, i) => (
              // ✅ Each gallery photo — individually clickable
              <div key={slot.key} className="rounded-3xl overflow-hidden shadow-md relative h-64 border-4 border-white">
                <DemoImage
                  storageKey={slot.key}
      ...
      <section className="py-24 px-4" style={{ backgroundColor: BG_ALT }}>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-8">
          <div className="flex-1 rounded-3xl p-10 border bg-white shadow-sm" style={{ borderColor: BORDER }}>
          ...
          <div className="flex-1 rounded-3xl p-10 flex flex-col justify-center text-center text-white relative overflow-hidden shadow-xl" style={{ backgroundColor: ACCENT }}>
